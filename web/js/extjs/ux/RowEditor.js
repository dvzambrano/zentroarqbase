...
Ext.ux.grid.RowEditor = Ext.extend(Ext.Panel, {
    ...
    onRender: function(){
        ...
        for(var i = 0; this.customBtns && i < this.customBtns.length; i++){
            this.customBtns[i]['width'] = this.minButtonWidth;
            btns.push(this.customBtns[i]);
        }
        btns.push({
            xtype: 'button',
        ...
        this.btns = new Ext.Panel({
            ...
            elements:'body',
            layout: 'table',
            width: (this.minButtonWidth * btns.length) + (this.frameWidth * btns.length) + (this.buttonPad * 4), // width must be specified for IE
            items: [btns]
        });
