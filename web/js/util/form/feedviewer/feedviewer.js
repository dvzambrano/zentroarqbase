...
Ext.SgArqBase.FeedGrid = function(viewer, config) {
    this.viewer = viewer;
    ...
    Ext.SgArqBase.FeedGrid.superclass.constructor.call(this, {
        region: 'center',
        id: 'topic-grid',
...
Ext.extend(Ext.SgArqBase.FeedGrid, Ext.grid.GridPanel, {
...
Ext.reg("sgarqbase.feedgrid", Ext.SgArqBase.FeedGrid);