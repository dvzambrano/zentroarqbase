 ...
 * @abstract
 */
Ext.SgArqBase.AbstractTreeStore = Ext.extend(Ext.data.Store,
{
    /**
    ...
    {
        Ext.SgArqBase.AbstractTreeStore.superclass.constructor.call(this, config);
        
        if (!this.paramNames.active_node) {
            this.paramNames.active_node = 'node';
        }
    ...
    remove : function(record)
    {
        ...
        // ----- End of modification        
        Ext.SgArqBase.AbstractTreeStore.superclass.remove.call(this, record);
    },
    ...
    load : function(options)
    {
        ...
        return Ext.SgArqBase.AbstractTreeStore.superclass.load.call(this, options); 
    },
   ...
   /**
    ...
    sort : function(fieldName, dir)
    {
        ...
        return Ext.SgArqBase.AbstractTreeStore.superclass.sort.call(this, fieldName, dir);         
    },    
 ...
 */
Ext.SgArqBase.AdjacencyListStore = Ext.extend(Ext.SgArqBase.AbstractTreeStore,
{
    /**
...
Ext.reg('Ext.SgArqBase.AdjacencyListStore', Ext.SgArqBase.AdjacencyListStore);

/**
 * Tree store for nested set tree representation.
 */
Ext.SgArqBase.NestedSetStore = Ext.extend(Ext.SgArqBase.AbstractTreeStore,
{
    /**
...
Ext.SgArqBase.GridView = Ext.extend(Ext.grid.GridView, 
{   
    ...
    initTemplates : function()
    {
        ...
        this.templates = ts;
        Ext.SgArqBase.GridView.superclass.initTemplates.call(this);
    },
    ...
    {
        Ext.SgArqBase.GridView.superclass.afterRender.call(this);
    ...
    ensureVisible : function(row, col, hscroll)
    {
        ...
        return Ext.SgArqBase.GridView.superclass.ensureVisible.call(this, row, col, hscroll);
    },
    ...
    {
        Ext.SgArqBase.GridView.superclass.initData.call(this, ds, cm);
        if (this.ds) {
    ...
    onLoad : function(store, records, options)
    {
        ...
        if (
            ...
            Ext.SgArqBase.GridView.superclass.onLoad.call(this, store, records, options);
        }
    },
    
    onAdd : function(ds, records, index)
    {
        Ext.SgArqBase.GridView.superclass.onAdd.call(this, ds, records, index);
        if (this.mainWrap) {
           //this.updateAllColumnWidths();
           this.processRows(0);
        }
    ...
    {
        Ext.SgArqBase.GridView.superclass.onRemove.call(this, ds, record, index, isUpdate);
        if(isUpdate !== true){
            if (this.mainWrap) {
                //this.updateAllColumnWidths();
                this.processRows(0);
    ...
    {
        Ext.SgArqBase.GridView.superclass.onUpdate.call(this, ds, record);
        if (this.mainWrap) {
            //this.updateAllColumnWidths();
            this.processRows(0);
        }
...
Ext.SgArqBase.GridPanel = Ext.extend(Ext.grid.GridPanel, 
{
    /**
    ...
    initComponent : function()
    {
        ...
        Ext.SgArqBase.GridPanel.superclass.initComponent.call(this);
    ...
    {
        Ext.SgArqBase.GridPanel.superclass.onRender.call(this, ct, position);
    ...
    {
        if (!this.view) {
            this.view = new Ext.SgArqBase.GridView(this.viewConfig);
        }
        return this.view;
    },
    ...
    onClick : function(e)
    {
        ...
        if (do_default) {
            Ext.SgArqBase.GridPanel.superclass.onClick.call(this, e);
        }
    },
    ...
    onMouseDown : function(e)
    {
        ...
        if (!Ext.fly(target).hasClass('ux-maximgb-tg-elbow-active')) {
            Ext.SgArqBase.GridPanel.superclass.onMouseDown.call(this, e);
        }
    },
...
Ext.SgArqBase.EditorGridPanel = Ext.extend(Ext.grid.EditorGridPanel, 
{
    /**
     * @cfg {String|Integer} master_column_id Master column id. Master column cells are nested.
     * Master column cell values are used to build breadcrumbs.
    ...
    initComponent : function()
    {
        ...
        Ext.SgArqBase.EditorGridPanel.superclass.initComponent.call(this);
    ...
    onRender : function(ct, position)
    {
        Ext.SgArqBase.EditorGridPanel.superclass.onRender.call(this, ct, position);
    ...
    onClick : function(e)
    {
        ...
        if (do_default) {
            Ext.SgArqBase.EditorGridPanel.superclass.onClick.call(this, e);
        }
    },
    ...
    onMouseDown : function(e)
    {
        ...
        if (!Ext.fly(target).hasClass('ux-maximgb-tg-elbow-active')) {
            Ext.SgArqBase.EditorGridPanel.superclass.onMouseDown.call(this, e);
        }
    },
 ...
 */
Ext.SgArqBase.PagingToolbar = Ext.extend(Ext.PagingToolbar,
{
    onRender : function(ct, position)
    {
        Ext.SgArqBase.PagingToolbar.superclass.onRender.call(this, ct, position);
        this.updateUI();
    },
    ...
    bindStore : function(store, initial)
    {
        ...
        Ext.SgArqBase.PagingToolbar.superclass.bindStore.call(this, store, initial);
    },
    ...
    beforeLoad : function(store, options)
    {
        ...
        Ext.SgArqBase.PagingToolbar.superclass.beforeLoad.call(this, store, options);
...
Ext.reg('Ext.SgArqBase.GridPanel', Ext.SgArqBase.GridPanel);
Ext.reg('Ext.SgArqBase.EditorGridPanel', Ext.SgArqBase.EditorGridPanel);
Ext.reg('Ext.SgArqBase.PagingToolbar', Ext.SgArqBase.PagingToolbar);
